...
export default function Page(){
  return <><section className="page-hero"><div className="container narrow"><span className="eyebrow">Privacy</span><h1>Privacy Policy</h1><p className="lead">Informazioni sul trattamento dei dati personali effettuato attraverso questo sito.</p></div></section><section className="section"><div className="container prose legal-copy">
    ...
    <p>Per l’infrastruttura del sito viene utilizzato <strong>Vercel</strong>. Per l’inoltro tecnico del modulo viene utilizzato <strong>Resend</strong>. Tali fornitori possono trattare dati personali e dati tecnici necessari a erogare i rispettivi servizi secondo i propri accordi sul trattamento dei dati e le proprie misure di sicurezza.</p>
    <p>L’utilizzo di fornitori internazionali può comportare trasferimenti di dati al di fuori dello Spazio Economico Europeo. Quando applicabile, tali trasferimenti sono gestiti mediante gli strumenti e le garanzie previsti dalla normativa europea e dagli accordi sul trattamento dei dati dei fornitori utilizzati.</p>
